...
GTEST_TEST(TestEthTxnDynFee, SignedTransaction)
{
...

	{
		...
		Transaction::ContractFuncStaticDef<AbiTupleWriter> func(
			gsk_testContractAddr,
			"foo"
		);

		auto txn = func.CallByTxn(
			SimpleObjects::UInt64(12345),
			std::forward_as_tuple(
				SimpleObjects::UInt64(54321),
				SimpleObjects::UInt64(67890)
			),
		...
		Transaction::SignTransaction(txn, keyPair);

		ASSERT_EQ(txn.get_v().size(), 1);
		EXPECT_EQ(txn.get_v()[0], 0x01U);

		std::vector<uint8_t> expectedSerialized = {
			0x02U, 0xf8U, 0xf2U, 0x82U, 0x07U, 0x6cU, 0x22U, 0x84U, 0x77U, 0x35U, 0x94U, 0x00U, 0x84U, 0x77U, 0x35U, 0x94U,
			0x00U, 0x83U, 0x01U, 0x86U, 0xa0U, 0x94U, 0x09U, 0x61U, 0x6cU, 0x3dU, 0x61U, 0xb3U, 0x33U, 0x1fU, 0xc4U, 0x10U,
			0x9aU, 0x9eU, 0x41U, 0xa8U, 0xbdU, 0xb7U, 0xd9U, 0x77U, 0x66U, 0x09U, 0x80U, 0xb8U, 0x84U, 0xfaU, 0x81U, 0xb4U,
			0x25U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x30U,
			0x39U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0xd4U,
			0x31U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x01U, 0x09U,
			0x32U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0xc0U, 0x01U, 0xa0U, 0xb0U, 0xe3U, 0xf0U, 0x36U, 0xceU, 0x14U, 0x5fU, 0x98U, 0xc5U, 0xd2U, 0x59U, 0x8fU,
			0x53U, 0x12U, 0x61U, 0xf3U, 0xebU, 0x5eU, 0xc5U, 0xadU, 0xe7U, 0x2aU, 0x92U, 0x1dU, 0xb8U, 0x9eU, 0x28U, 0x75U,
			0x6dU, 0x8bU, 0xd1U, 0xc6U, 0xa0U, 0x64U, 0x96U, 0x99U, 0x1aU, 0xa1U, 0x6dU, 0x6dU, 0xa5U, 0x85U, 0x1aU, 0xd4U,
			0x88U, 0x34U, 0x6fU, 0x71U, 0xd3U, 0xb1U, 0xddU, 0xa7U, 0xbfU, 0x15U, 0x93U, 0xb5U, 0xe2U, 0x61U, 0xb6U, 0xabU,
			0xd3U, 0xf5U, 0x8aU, 0x43U, 0x69U,
		};
		...
		// std::cout << "Expected RLP:  " <<
		// 	SimpleObjects::Codec::Hex::Encode<std::string>(expectedSerialized) << std::endl;
		// std::cout << "Generated RLP: " <<
		// 	SimpleObjects::Codec::Hex::Encode<std::string>(rlp) << std::endl;
		// std::cout << "Generated R: " <<
		// 	SimpleObjects::Codec::Hex::Encode<std::string>(txn.get_r()) << std::endl;
		// std::cout << "Generated S: " <<
		// 	SimpleObjects::Codec::Hex::Encode<std::string>(txn.get_s()) << std::endl;
	}

	{
		...
		auto keyPair = mbedTLScpp::EcKeyPair<mbedTLScpp::EcType::SECP256K1>::
			FromSecretNum(
				mbedTLScpp::BigNum(
					"8b03d7fdc28059800b252d475164a581d94563c9a39f435dc9b130acb5ab93bb",
					/*radix=*/16
				),
				*rand
			);
		...
		EXPECT_EQ(txn.get_v().size(), 0);

		std::vector<uint8_t> expectedSerialized = {
			0x02U, 0xf9U, 0x01U, 0x95U, 0x82U, 0x07U, 0x6cU, 0x22U, 0x84U, 0x77U, 0x35U, 0x94U, 0x00U, 0x84U, 0x77U, 0x35U,
			0x94U, 0x00U, 0x83U, 0x01U, 0x86U, 0xa0U, 0x94U, 0x09U, 0x61U, 0x6cU, 0x3dU, 0x61U, 0xb3U, 0x33U, 0x1fU, 0xc4U,
			0x10U, 0x9aU, 0x9eU, 0x41U, 0xa8U, 0xbdU, 0xb7U, 0xd9U, 0x77U, 0x66U, 0x09U, 0x82U, 0x03U, 0xe8U, 0xb9U, 0x01U,
			0x24U, 0xf4U, 0xdcU, 0x33U, 0x21U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x30U, 0x39U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x60U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0xd4U, 0x31U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x40U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x01U, 0x09U, 0x32U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x40U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x05U, 0x01U, 0x02U, 0x03U, 0x04U, 0x05U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
			0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0xc0U, 0x80U, 0xa0U, 0x7fU, 0x31U, 0xe9U, 0x0dU, 0x3cU, 0x0aU, 0x0cU, 0x0dU,
			0x24U, 0x65U, 0xafU, 0x4eU, 0xc3U, 0x1aU, 0xe1U, 0xe6U, 0x26U, 0xfeU, 0xd0U, 0x26U, 0x09U, 0x89U, 0xf2U, 0xc4U,
			0xc9U, 0x04U, 0x20U, 0x3aU, 0x22U, 0x77U, 0xc3U, 0xa4U, 0xa0U, 0x75U, 0x2aU, 0xc9U, 0x65U, 0x88U, 0xf3U, 0xabU,
			0x28U, 0x08U, 0x78U, 0x7cU, 0x5bU, 0x8fU, 0xa1U, 0xf5U, 0xb3U, 0xadU, 0xc0U, 0x86U, 0xedU, 0x27U, 0x34U, 0x91U,
			0x36U, 0xb1U, 0x94U, 0xc2U, 0x14U, 0xe5U, 0x52U, 0x5eU, 0x77U,
		};
