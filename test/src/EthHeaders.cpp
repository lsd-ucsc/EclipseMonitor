...
const std::array<uint8_t, 535>& EclipseMonitor_Test::GetEthHeaderBin_0()
{
	static const std::array<uint8_t, 535> inst {
...
const std::array<uint8_t, 532>& EclipseMonitor_Test::GetEthHeaderBin_1()
{
	static const std::array<uint8_t, 532> inst {
...
static std::array<uint8_t, 532> BuildEthHeaderBin_1_ErrNum()
{
	std::array<uint8_t, 532> inst = EclipseMonitor_Test::GetEthHeaderBin_1();
	inst[454] = 0x02U; // The single byte of the number
	return inst;
} // BuildEthHeaderBin_1_ErrNum()

const std::array<uint8_t, 532>& EclipseMonitor_Test::GetEthHeaderBin_1_ErrNum()
{
	static const std::array<uint8_t, 532> inst = BuildEthHeaderBin_1_ErrNum();

	return inst;
} // GetEthHeaderBin_1_ErrNum()

static std::array<uint8_t, 532> BuildEthHeaderBin_1_ErrParentHash()
{
	std::array<uint8_t, 532> inst = EclipseMonitor_Test::GetEthHeaderBin_1();
...
const std::array<uint8_t, 532>& EclipseMonitor_Test::GetEthHeaderBin_1_ErrParentHash()
{
	static const std::array<uint8_t, 532> inst = BuildEthHeaderBin_1_ErrParentHash();

	return inst;
} // GetEthHeaderBin_1_ErrParentHash()

static std::array<uint8_t, 532> BuildEthHeaderBin_1_ErrDiffVal()
{
	std::array<uint8_t, 532> inst = EclipseMonitor_Test::GetEthHeaderBin_1();
...
const std::array<uint8_t, 532>& EclipseMonitor_Test::GetEthHeaderBin_1_ErrDiffVal()
{
	static const std::array<uint8_t, 532> inst = BuildEthHeaderBin_1_ErrDiffVal();
