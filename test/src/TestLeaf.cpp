...
GTEST_TEST(TestLeafNode, RawTest1)
{
    ...
    std::unique_ptr<Leaf::LeafNode> leafNode = Leaf::LeafNode::NewLeafNodeFromBytes(nibbleBytes, val);
...
GTEST_TEST(TestLeafNode, HashTest1)
{
    ...
    std::unique_ptr<Leaf::LeafNode> leafNode = Leaf::LeafNode::NewLeafNodeFromNibbles(nibbles, val);
